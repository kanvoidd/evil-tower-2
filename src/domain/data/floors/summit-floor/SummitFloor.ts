...
export class SummitFloor extends FloorFactory {
  ...
  createEnemies(): EnemyDef[] {
    return [
      ...
      this.enemy('dark_knight', 'Тёмный рыцарь', 'Dark Knight', 'tough', 'humanoid', { enrage: 0.2 }),
      this.enemy('void_herald', 'Вестник пустоты', 'Void Herald', 'elite', 'demon', { magic: true, evade: 15 }),
      this.enemy('boss_demon', 'Владыка башни', 'Tower Lord', 'boss', 'demon', { magic: true, armor: 18, enrage: 0.1 }),
    ];
  }
}
