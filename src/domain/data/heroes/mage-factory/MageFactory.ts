import { SpellAttack } from '../../../logic/hero/attack/spell-attack/SpellAttack';
...
export class MageFactory extends HeroFactory {
  ...
  createLineage(): LineageDef {
    return this.lineageDef({
      ...
      resMax: 14, resRegen: 1, goldBonus: 0, artifacts: true,
      ...
      ...this.talentTree('mage', [
        ...
        },
        {
          a: [
            ...
            this.talent('Сила магического выстрела', 'Arcane Shot Power', 'shotPower', [10, 20, 30, 40, 50]),
          ],
          v: [
