 ...
 *
 * Семейство продуктов — все карты одного захода в комнату: враги, добыча, призраки и выход.
...
export abstract class CardFactory implements IDeckSupply {
  ...
  /** Призрак некроманта: союзник, который несколько ходов бьёт соседей. */
  createGhost(ttl: number): Card {
    return this.make({ kind: 'ghost', ttl });
  }
