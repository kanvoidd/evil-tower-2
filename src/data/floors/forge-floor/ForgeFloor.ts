...
export class ForgeFloor extends FloorFactory {
  ...
  createEnemies(): EnemyDef[] {
    return [
      ...
      this.enemy('magma_golem', 'Магмовый голем', 'Magma Golem', 'tough', 'construct', { armor: 12, thorns: 0.25 }),
      this.enemy('demon_smith', 'Демон-кузнец', 'Demon Smith', 'tough', 'demon', { enrage: 0.15 }),
      this.enemy('brimstone_brute', 'Серный громила', 'Brimstone Brute', 'elite', 'demon', { venom: 0.2, armor: 8 }),
      this.enemy('boss_forge_demon', 'Владыка кузни', 'Lord of the Forge', 'boss', 'demon', { thorns: 0.2, armor: 10 }),
    ];
  }
}
