...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'tycoon', name: { ru: 'Богач', en: 'Tycoon' }, desc: { ru: 'Соберите 20000 золота', en: 'Collect 20000 gold' }, target: 20000, progress: count('goldEarned') },
  ...
  { id: 'floor_3', name: { ru: 'Владыка башни', en: 'Master of the Tower' }, desc: { ru: 'Пройдите 3 этаж', en: 'Clear floor 3' }, target: 1, progress: floorCleared(3) },
