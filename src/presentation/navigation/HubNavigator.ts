...
export class HubNavigator implements IHubNavigator {
  private static readonly SCENES: Record<HubMenu, string> = {
    shop: 'Shop', levels: 'Levels', settings: 'Settings', skill: 'SkillTree', achievements: 'Achievements',
  };

  constructor(private readonly scene: Phaser.Scene, private readonly view: HubView) {}
